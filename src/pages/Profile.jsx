...
export const Profile = React.memo(() => {
    ...
    useEffect( () => {
        if(didFetch.current)
            ...
            const getAllDocuments = async (collectionName) => {
                try {
                    ...
                    const qry = query(collection(db, collectionName), where("userID", "==", user.uid));
        ...
        user && getAllDocuments("checkouts");
    }, [user]);
    ...
    return <div className={"pb-5"}>
        ...
        <div className={"p-5"}>
            {
                !data[0]?.message ? <table className="table table-striped table-bordered w-full overflow-x-auto">
                        <thead
