...
export const MyTextField = ({label, children, ...props}) => {
    ...
    return  (<>
        ...
        <div className="relative w-full h-[50px]">
            ...
            <input
                className={`input-form py-3 px-[40px] shadow-lg rounded-sm absolute min-w-full min-h-full transition ease-in-out focus:outline-none focus:border-b-2 ${meta.touched && meta.error ? 'focus:border-b-red-500' : meta.touched ? 'border-green-500' : 'text-black'}`}
                {...field} {...props} />
        </div>
        {
